...
test.describe('[UI] AD-79 TS-001: Dealer Login - Invalid Email', { tag: ['@regression'] }, () => {
  let loginPage;

  test('[AD-79 TS-001 TC-002] Verify login failure with invalid email address', async ({ page }) => {
    ...
    await expect(loginPage.page.locator('input[type="email"]')).toHaveValue(TD.credentials.invalidEmail.email);
