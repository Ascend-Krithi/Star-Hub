...
test.describe('[UI] AD-79 TS-001: Invalid Email Login Test', { tag: ['@regression', '@dealer-app'] }, () => {
  let loginPage;

  test('[AD-79 TS-001 TC-002] Verify error message is displayed for invalid email', async ({ page }) => {
