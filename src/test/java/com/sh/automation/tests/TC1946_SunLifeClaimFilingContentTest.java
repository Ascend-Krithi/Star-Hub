...
public class TC1946_SunLifeClaimFilingContentTest extends BaseTest {

    @Test(testName = "TC1946", description = "Test Case - SCRUM-27502 TS-003 TC-001", groups = {"TS003", "Functional", "Regression"}, priority = 8)
    public void verifyClaimFilingContentVisible() {
        // TestRail Case ID: TC1946
