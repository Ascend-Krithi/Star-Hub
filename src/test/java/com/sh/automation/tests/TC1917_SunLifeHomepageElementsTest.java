...
public class TC1917_SunLifeHomepageElementsTest extends BaseTest {

    @Test(testName = "TC1917", description = "Test Case - SCRUM-27502 TS-002 TC-001", groups = {"TS002", "Functional", "Regression"}, priority = 2)
    public void verifyHomepageElementsVisible() {
        // TestRail Case ID: TC1917
