...
public class TC1947_SunLifeClaimButtonTest extends BaseTest {
    ...
    /**
     * TestRail Case ID: 1947
     * Test Case - SCRUM-27502 TS-004 TC-001
     */
    @Test(testName = "TC1947", description = "Verify 'File a claim now' button is visible, enabled, and labeled correctly.", groups = {"TS004", "Functional", "Regression"}, priority = 9)
    public void verifyFileAClaimNowButton() {
        ...
        // Step 2: Locate 'File a claim now' button
