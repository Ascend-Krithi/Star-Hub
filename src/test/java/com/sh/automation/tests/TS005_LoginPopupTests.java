...
public class TS005_LoginPopupTests extends BaseTest {
    ...
    private static final String POPUP_MSG = "Please log in or create an account to continue with your purchase";

    /**
     * TestRail Case ID: TC556
     * Test Name: Test Case - SCRUM-22697 TS-006 TC-001
     */
    @Test(testName = "TC556", description = "Test Case - SCRUM-22697 TS-006 TC-001", groups = {"TS005", "Functional", "Regression"}, priority = 1)
