...
public class TS005_LoginPopupTests extends BaseTest {
    /**
     * TestRail Case ID: TC605
     * Test Name: Test Case - SCRUM-22697 TS-007 TC-001
     */
    @Test(testName = "TC605", description = "Test Case - SCRUM-22697 TS-007 TC-001", groups = {"TS005", "Functional", "Regression"}, priority = 7)
    public void verifyLoginPopupAppearsWhenNotLoggedIn() {
        ...
        Assert.assertEquals(loginPopup.getPopupMessageText(), POPUP_MSG, "Popup message did not match");
    }
}
