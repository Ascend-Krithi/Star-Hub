...
public class TC556_LoginPopupAppearsWhenNotLoggedInTest extends BaseTest {
    @Test(testName = "TC556", description = "Test Case - SCRUM-22697 TS-006 TC-001", groups = {"TS006", "Functional", "Regression"}, priority = 6)
    public void verifyLoginPopupAppearsWhenNotLoggedIn() {
        // TC556: Test Case - SCRUM-22697 TS-006 TC-001
        // Preconditions: Ensure user is not logged in
        ...
        Assert.assertTrue(loginPopupPage.isPopupDisplayed(), "Login popup was not displayed");
        Assert.assertEquals(loginPopupPage.getPopupMessageText(), "Please log in or create an account to continue with your purchase", "Login popup message text mismatch");
    }
}
