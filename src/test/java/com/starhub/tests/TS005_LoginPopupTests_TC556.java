...
public class TS005_LoginPopupTests_TC556 extends BaseTest {
    ...
    public void verifyLoginPopupAppearsWhenNotLoggedIn() {
        ...
        Assert.assertTrue(loginPopupPage.isPopupDisplayed(), "Login popup window is not displayed");
        Assert.assertTrue(loginPopupPage.isLoginMessageCorrect(), "Login popup message is incorrect");
    }
}
