...
public class TC556_TestCase extends BaseTest {
    @Test(testName = "TC556", description = "Test Case - SCRUM-22697 TS-006 TC-001", groups = {"TS006", "Functional", "Regression"}, priority = 15)
