...
public class TC554_TestCaseSCRUM22697TS004TC001 extends BaseTest {
    @Test(testName = "TC554", description = "Test Case - SCRUM-22697 TS-004 TC-001", groups = {"TS8", "Functional", "Regression"}, priority = 13)
    public void verifyDefaultSelectionsOnDevicePage() {
        ...
        Assert.assertTrue(deviceDetailPage.areAllOptionsVisible(), "All selected options should be clearly visible");
    }
}
