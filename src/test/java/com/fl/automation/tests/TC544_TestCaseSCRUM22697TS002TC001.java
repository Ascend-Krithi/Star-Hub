...
public class TC544_TestCaseSCRUM22697TS002TC001 extends BaseTest {
    @Test(testName = "TC544", description = "Test Case - SCRUM-22697 TS-002 TC-001", groups = {"TS8", "Functional", "Regression"}, priority = 3)
