...
public class TC553_TestCaseSCRUM22697TS003TC001 extends BaseTest {
    @Test(testName = "TC553", description = "Test Case - SCRUM-22697 TS-003 TC-001", groups = {"TS8", "Functional", "Regression"}, priority = 12)
    public void verifyDeviceDetailPageLoads() {
        ...
        Assert.assertTrue(allPhonesPage.isDeviceVisible(DEVICE_NAME), DEVICE_NAME + " should be visible in the device list");
